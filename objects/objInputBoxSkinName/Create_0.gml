...
var _defaultArray = ["Nome Skin",FontGame,true];
var _hideArray = [false,"*",fnt_hide,font_get_size(fnt_hide)+8];
var _excludedArray = [";","!"];
input_box_init(xInitial,yInitial,192,24,font_get_size(FontGame)+7,false,_defaultArray,192-(4*3),30,6,FontGame,1,_hideArray,0,_excludedArray,objInputBoxSkinPath);
